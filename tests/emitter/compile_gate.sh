...
D=$(pwd)
INC="-I$D -I$D/pcsx2 -I$D/pcsx2/x86 -I$D/common -I$D/common/include -I$D/libretro -I$D/libretro/libretro-common/include -I$D/3rdparty -I$D/3rdparty/include -I$D/3rdparty/xbyak"
