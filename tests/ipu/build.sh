...
g++ -O2 -msse4.1 -std=c++17 $INC -c tests/ipu/main.cpp  -o tests/ipu/main.o
g++ -O2 -msse4.1 -std=c++17 $INC -c tests/ipu/stubs.cpp -o tests/ipu/stubs.o
CPUOBJS=$(find 3rdparty/cpuinfo -name "*.o")
g++ -o tests/ipu/ipu_test tests/ipu/main.o tests/ipu/stubs.o \
