...
bool VKTexture::Adopt(VkImage existing_image, VkImageViewType view_type, u32 width, u32 height, u32 levels,
...
void VKTexture::OverrideImageLayout(VkImageLayout new_layout) { m_layout = new_layout; }
		...
		u32 start_layer, u32 num_layers, VkImageLayout old_layout, VkImageLayout new_layout)
{
	...
	else if (IsDepthFormat(m_format))
