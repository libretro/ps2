...
"	int n = textureSize(PaletteSampler, 0).y;\n"
"	ivec2 sub = ivec2(0);\n"
"	if (n > 1)\n"
"	{\n"
...
"	}\n"
"	return texelFetch(PaletteSampler, ivec2(int(idx) * n + sub.x, sub.y), 0);\n"
"}\n"
"\n"
...
"#else\n"
"	return int(texelFetch(TextureSampler, ivec2(gl_FragCoord.xy + ChannelOffset.xy), 0).r * multiplier);\n"
"#endif\n"
"}\n"
"\n"
...
"	return fetch_rt();\n"
"#else\n"
"	return texelFetch(TextureSampler, ivec2(gl_FragCoord.xy + ChannelOffset.xy), 0);\n"
"#endif\n"
"}\n"
"\n"
...
"	#endif\n"
"#if PS_PAL_FMT != 0\n"
"	c[0] = sample_p(uint(texelFetch(TextureSampler, p, 0).a * 255.5f));\n"
"#else\n"
"	c[0] = texelFetch(TextureSampler, p, 0);\n"
"#endif\n"
"#else\n"
"	uv = clamp_wrap_uv(uv);\n"
"\n"
...
"	vec2 st = clamp(PSin.t_float.xy / vec2(PSin.t_float.w), vec2(-2047.0f), vec2(2047.0f));\n"
