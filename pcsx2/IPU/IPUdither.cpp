...
static __ri void ipu_dither_vector(const macroblock_rgb32 &rgb32, macroblock_rgb16 &rgb16, const int dte)
{
...
#if 0
/* Reference C version */
static __ri void ipu_dither_reference(const macroblock_rgb32 &rgb32, macroblock_rgb16 &rgb16, const int dte)
{
    if (dte) {
...
{
    ipu_dither_vector(rgb32, rgb16, dte);
}
